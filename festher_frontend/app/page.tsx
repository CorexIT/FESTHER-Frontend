...
export default function Home(){
 ...
 <section className="hero" id="home">
  ...
  <nav className="navbar" aria-label="Main navigation"><a href="#home" className="brand"><span className="brand-name">FESTHER</span><span className="brand-tagline">Every Moment, A Celebration</span></a><div className="nav-links"><a className="active" href="#home">Home</a><a href="#services">Services</a><a href="#packages">Packages & Offers</a><a href="#hotel">Hotel & Villa</a><a href="#restaurant">Restaurant</a><a href="#gallery">Gallery</a><a href="#about">About</a><a href="#contact">Contact</a></div><a href="#booking" className="nav-cta">Book now <span>↗</span></a></nav>
